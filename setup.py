...
#
	parameters = { "install_data_plain_copy_extensions": "json",
	               "pasGapiGStreamerVersion": get_version()
	             }
	...
	setup(name = "pas_gapi_gstreamer",
	      version = get_version(),
	      description = "Python Application Services",
	      long_description = """"pas_gapi_gstreamer" is an adapter and abstraction layer for the C-Level GStreamer API.""",
	      author = "direct Netware Group et al.",
	      author_email = "web@direct-netware.de",
	      license = "GPLv2+",
	      url = "https://www.direct-netware.de/redirect?pas;gapi;gstreamer",
